...
export class BlogGrid extends Component {
    ...
    getListContents = () => {
        let pageFirstContentId = (this.props.pageNumActive * this.contentsPerPage) - this.contentsPerPage + 1,
        ...
        let blogItems = this.props.blogGridProps
            ...
            .map((props, i) =>
                ...
                >
                    ...
                    >
                        <a href={`/blog-singles/${props.id}`} className="block-20"
                        ...
                        >
                            ...
                            <h3 className="heading"><a href={`/blog-singles/${props.id}`}>{props.contentHeading}</a></h3>
                        </div>
                    </div>
                </div>
            )
        ...
        return (
            <section className="ftco-section">
                <div className="container mt-5">
                    ...
                    <PageNumNav pageNumClicked={this.pageNumClicked} incrementPageNumMinAndMax={this.incrementPageNumMinAndMax} decrementPageNumMinAndMax={this.decrementPageNumMinAndMax}     {...this.props} />
                </div>
            </section>
        );
    }
