...
const Author = ({ author, authorImage, aboutAuthor }) =>
  <div
    className="about-author d-flex pt-5"
  >
    <div
      className="bio align-self-md-center mr-4"
    >
      <img
        src={authorImage}
        alt={author}
...
export class BlogSingle extends Component {
  ...
  render = () => {
    let { author, authorImage, authorLink, aboutAuthor, contentHeading, content, tags, comment, commentCount, commentCountLink } = this.props;
    return (
