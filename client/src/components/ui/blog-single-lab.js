...
let authorProps = {
  ...
  "about": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus itaque, autem necessitatibus voluptate quod mollitia delectus aut, sunt placeat nam vero culpa sapiente consectetur similique, inventore eos fugit cupiditate numquam!"
}

const Author = () => (
  <div
    class="about-author d-flex pt-5">
    <div
      class="bio align-self-md-center mr-4"
    >
      <img
    ...
    <div
      class="desc align-self-md-center"
    >
      <h3>
        {authorProps.heading}
      </h3>
...
const Comment = () => (
  ...
  >
    <h3 class="mb-5"
    >
      {`${commentProps.length} Comments`}
    </h3>
    <ul class="comment-list"
    >
      {commentProps.map((props, i) => (
        <li class="comment"
          key={i}
        >
          <div class="vcard bio"
                ...
                {props.replys.map((prop, id) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p><a href={`/${i}/reply`} class="reply">Reply</a></p>
                    </div>
                  </li>
