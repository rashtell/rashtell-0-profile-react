...
export const AboutSec = () => {
    return (
        <section
            className={aboutData.section.className}
        >
            <div
                className={aboutData.div1.className}
            >
                <AboutFrag />
            </div>
        </section >
...
export const AboutMe = () => {
    return (
        <>
            <h1
                className={aboutMeProps.h1.className}
            >
                {aboutMeProps.h1.text}
            </h1>
            <div
                className={aboutMeProps.div.className}
            >
...
export const AboutFrag = () =>
    ...
    >
        ...
        <div
            className={aboutData.div4.className}
        >
        </div>
        <div
            className={aboutData.div5.className}
        >
            <div
                className={aboutData.div6.className}
            >
                <AboutMe />
